...
HELP_MESSAGE = 'Ты мне слово я тебе анекдот. Анекдот может быть бородатым ' \
               'и не смешным за это можешь поставить ему плохую оценку или ' \
               'хорошую если анекдот смешной. ' \
